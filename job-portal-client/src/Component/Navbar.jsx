...
const Navbar = () => {
  ...
  return (
    <header className="max-w-screen-2xl container mx-auto xl:px-24 px-4 relative" ref={menuRef}>
          ...
          {!loading && user && (
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-medium max-w-[140px] truncate" title={user.displayName || user.email}>
              ...
              <button onClick={signOutUser} className="py-1 px-3 border rounded text-sm hover:bg-red-700 bg-red-600 text-white transition" aria-label="Logout">Logout</button>
            </div>
          )}
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-gray-900 truncate" title={user.displayName || user.email}>
                        {user.displayName || user.email}
                      </p>
                      {userRole && (
